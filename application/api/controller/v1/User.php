...
class User extends BaseController
{
     ...
     * @apiExample {get}  请求样例:
     * https://tonglingok.com/api/v1/users?page=1&size=10&name=''&time_begin=''&time_end=''&phone=''&company_id=0
     ...
     * @apiParam (请求参数说明) {int} company_id  选择代理商id：系统管理员（grade=3） 获取全部传入0 ，其他角色不需要传入此参数
     * @apiSuccessExample {json} 返回样例:
     ...
     */
    public function users($page = 1, $size = 10, $name = '', $time_begin = '', $time_end = '', $phone = '',$company_id = 0)
    {
        $users = (new UserService())->users($page, $size, $name, $time_begin, $time_end, $phone, $company_id);
